...
Last synced from plan version **0.6.59-plan** (2026-07-24).
...
| **Q53:** Collection kind = **has_type only** | Done (planning) |
| **Q54:** hierarchy = same Edge/Relation table (`contains`); `parent_id` = cache | Done (planning) |
