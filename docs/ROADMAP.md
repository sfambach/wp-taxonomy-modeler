...
Last synced from plan version **0.6.58-plan** (2026-07-24).
...
| **Q53:** Collection kind binding — lean **has_type only** (tree org-only) | Open (strong lean) |
| **Q54:** hierarchy as Relation (`contains`) vs org-only `parent_id` | Exploring |
