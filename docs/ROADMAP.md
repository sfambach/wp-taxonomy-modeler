...
Last synced from plan version **0.4.1-plan** (2026-07-23).
...
| Data structure: Node (parent/children → trees/forests) | In progress |
| Data structure: Parameter (one node → several parameters) | In progress |
