...
|---|---|---|---|
| 00 | [Vision and scope](00-vision-and-scope.md) | `draft` | owner statements V1–V9 |
...
| 20 | [Interaction](20-interaction.md) | `open` | U1 … U8 |
...
| 90 | [Decision log](90-decision-log.md) | `open` | D-001 … D-185 |
| 91 | [Open questions](91-open-questions.md) | `open` | OQ-001 … OQ-074 (70 answered or closed, 4 open) |
