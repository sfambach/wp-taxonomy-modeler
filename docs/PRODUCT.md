...
- One node can have several parameters; each parameter **always has a type**; a type **can** have a unit (e.g. kOhm) or none (e.g. URL); parameter single-owner rule is still **?** .
