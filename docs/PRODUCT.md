...
- Emerging type model: **template** holds simples + **quantity** + **Collection**. **Q56:** Composition = Definition (Spalten+Typen) + Instanz; UX Zusammenstellung / internal Composition. Worked column sets: BOM, Rezept, GPU (draft), Widerstand.
