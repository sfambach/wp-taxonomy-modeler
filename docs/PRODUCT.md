...
- Emerging type model: **template** holds simples + **quantity** + **Collection**. **Q54:** catalog tree. **Q55:** Parameter defs. **Q56:** Composition concept (GPU-Ausprägung, BOM, Build, …). **Naming decided:** UX **Zusammenstellung**, internal **Composition**.
