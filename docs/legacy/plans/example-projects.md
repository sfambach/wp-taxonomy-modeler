...
| BOM in tree | Structure node **`BOM`** = `composition` of **Name** + **Tabelle** (`type=table`) (**Q61**/Q63) |
| Name | Composition member of BOM (text); filled on **WP page/block** — not part of the `table` type |
| BOM title under table | `BOM als Bauteilliste – {Name}` (instance) |
| Table bands | **Zeile** required (1..n fields); optional **Kopf** / **Fuss** with same field count (**Q57**) |
| WP Block | Pick table-typed Collection; fill Name + rows from Zeile fields (**Q62**) |
...
| Attributes on part nodes | Typed child Nodes; Relations exploratory | Q64 superseded, Q35, Q42, Q66 |
