...
**Q53/Q54:** open again after closed thought experiment (hierarchy-as-edges + `parent_id` cache **excluded**). Restart under design guidelines: **clear structures**; **do not refuse named objects** where they fit better. Baseline tree remains `parent_id` until a fresh decision.  
