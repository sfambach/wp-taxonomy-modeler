...
**Q53–Q56:** Composition = **Definition** (columns+types) + **Instanz**; naming Zusammenstellung/Composition decided. Worked schemas BOM/Rezept/GPU/Widerstand. **Composition-Ref** type still a gap. **Q55** Parameter spin. **Q53** open.  
