...
**Q53–Q56:** **Q54/Q56 strong leans** — catalog (Vorlage/Ausprägung); **Composition** / UX **Zusammenstellung** (GPU card *is* a composition; compare compositions; BOM/Build nest them). **Q55** Parameter spin. **Q53** open.  
