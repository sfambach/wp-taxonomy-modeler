...
| Q14 | How does Parameter relate to Node? | Parameters belong to one node / inherited down the tree / global per taxonomy | Node owns several parameters (working assumption) | open |
