...
| Q36 | What is the core Type catalog? | Fixed list vs extensible | Leaning: string, number, integer, boolean, url, file, **enum**, **measure**; **string_list?** for open lists like RefDes (Q47) | open |
