	...
	private static function build_config(): array {
		...
		$config = array(
			...
			'i18n'       => array(
				...
				'attributesFixed' => __( 'Default value', 'wp-taxonomy-tree' ),
				'attributesReadonly' => __( 'Readonly', 'wp-taxonomy-tree' ),
				...
				'previewRebuildEmpty'=> __( 'Preview rebuild — add attributes to see Form and Table samples.', 'wp-taxonomy-tree' ),
				'previewAttributeHostHint'=> __( 'Form = one filled instance; Table = list of sample instances. Editable samples stay in this session only.', 'wp-taxonomy-tree' ),
